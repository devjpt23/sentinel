...
const METRICS: MetricDef[] = [
  ...
  },
  {
    ...
    color: (i) => (i.growth_3m !== null ? (i.growth_3m >= 0 ? "text-emerald-400" : "text-red-400") : ""),
  },
  {
    key: "growth_6m",
    label: "6M Growth",
    format: (i) => (i.growth_6m !== null ? formatPct(i.growth_6m) : "N/A"),
    color: (i) => (i.growth_6m !== null ? (i.growth_6m >= 0 ? "text-emerald-400" : "text-red-400") : ""),
  },
  {
    key: "growth_12m",
    label: "12M Growth",
    format: (i) => (i.growth_12m !== null ? formatPct(i.growth_12m) : "N/A"),
    color: (i) => (i.growth_12m !== null ? (i.growth_12m >= 0 ? "text-emerald-400" : "text-red-400") : ""),
  },
  {
    key: "fair_value",
    label: "Fair Value",
  ...
  },
  {
    ...
    color: (i) => (i.upside_pct !== null ? (i.upside_pct >= 0 ? "text-emerald-400" : "text-red-400") : ""),
  },
];
    ...
    <Card>
      ...
      <CardContent className="p-0 overflow-x-auto">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="w-48 sticky left-0 bg-[#0a0e13] z-10">Metric</TableHead>
              {items.map((item) => (
                <TableHead key={item.ticker} className="text-center min-w-[100px]">
                  <span className="text-[#84cc16] font-semibold">{item.ticker}</span>
                </TableHead>
              ))}
            </TableRow>
          </TableHeader>
